...
\begin{lstlisting}
https://github.com/Padmanabhk1/Assignment-4.git
\end{lstlisting}
%
...
\begin{align}
     \myvec{5& -3& 11\\
           -10 & 6 & -22}
          \xleftrightarrow{R_1 \leftarrow\frac{1}{5}{R_1}}
    \myvec{1&\frac{-3}{5}&\frac{11}{5}\\
        -10&6&-22}\\
        \xleftrightarrow{R_2\leftarrow  10R_1+R_2}
    \myvec{1&\frac{-3}{5}&\frac{11}{5}\\0&0&0}
    \end{align}
 ...
 \begin{align}
    \myvec{5& -3& 11\\
           -10 & 6 & -22}
 \end{align}
 gives matrix with 2 nonzero row, So it's rank is 1. 
   \begin{align}
       \myvec{5&-3\\-10&6}
   \end{align} 
  Also,the rank of the above matrix is also 1.
   
   $\therefore$ lines are Consistent and gives infinite solution.
